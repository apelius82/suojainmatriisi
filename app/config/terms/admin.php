...
return [
    ...
    'ppe_usage_targets'     => ['fi' => 'Missä tehtävissä tätä käytetään?', 'sv' => 'I vilka uppgifter används detta?', 'en' => 'In which tasks is this used?', 'it' => 'In quali attività viene usato?', 'el' => 'Σε ποιες εργασίες χρησιμοποιείται;'],
];
